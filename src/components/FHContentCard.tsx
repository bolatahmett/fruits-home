        ...
        return (
            <>
                ...
                >
                    <Row>
                        <Col span={12}>
                            <Meta className={"fhcontentcard-meta"}
                                avatar={
                                    <img
                ...
                <FHPopup visible={this.state.popupVisible} content={<></>} title={""} />
            </>
        )
    }
}
